...
const rincon = () =>{
  ...
  <Box color="#7d7d7d">
    ...
    Rincón Francés Crepería & Cafetería 
    </Text>
  </Box>
  <HStack  width='auto'>
  <Box
...
<GridItem pl='3' bg='white' height='500px'area={'nav'}>
 ...
 <Box>
 <Image src="./src/img/rincon fondo.jpg" height='500px' width='700px' alt="logo" align='center'></Image>
 </Box>
...
<Box >
   Rincón Francés
 <Image src="./src/img/logo_rinconfrances.jpeg" height='150px' width='90px' alt="eee" position='relative' display='block' margin='auto' align='right'></Image>
 </Box>
</GridItem>
...
<Box height='50px'></Box>
 ...
 <HStack>
  ...
  <Text color="black"> 933 558 035</Text>
  </HStack>
  <HStack>
...
<HStack spacing='220px'>
    <Box w='500px' h='200px' bg='white' >
        <Box height='50px'></Box>
        <Text color="black">El mejor lugar en Chimbote para disfrutar </Text>
        <Text color="black"> de un buen café. Anímate a probar nuestros deliciosos crepe.</Text>
  ...
  <HStack justifyContent='center' gap="5rem" >
    <Image  width='200px' height='200px'src="./src/img/rincon 1.jpg" alt="platos" ></Image>
    <Image width='200px' height='200px'src="./src/img/rincon 2.jpg" alt="platos" ></Image>
    <Image width='200px' height='200px' src="./src/img/rincon 3.jpg" alt="platos" ></Image>
