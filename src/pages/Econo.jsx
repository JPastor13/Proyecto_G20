...
<GridItem pl='3' bg='white' height='500px'area={'nav'}>
 ...
 <Box>
 <Image src="./src/img/econo fondo.jpg" height='500px' width='700px' alt="logo" align='center'></Image>
 </Box>
...
<Box >
Econovision Optica's 
 <Image src="./src/img/logo 3.png" height='150px' width='90px' alt="eee" position='relative' display='block' margin='auto' align='right'></Image>
 </Box>
</GridItem>
...
<Box height='50px'></Box>
 ...
 <HStack>
  ...
  <Text color="black"> 933 543 321</Text>
  </HStack>
  <HStack>
  ...
  <Text color="black">2do Piso</Text>
  </HStack>
...
<HStack spacing='220px'>
    <Box w='500px' h='200px' bg='white' >
        <Box height='50px'></Box>
        <Text color="black">Profesionalidad , Economía y Calidad
         </Text>
        <Text color="black">  al alcance de nuestros Clientes .</Text>
  ...
  <HStack justifyContent='center' gap="5rem" >
    <Image  width='200px' height='200px'src="./src/img/econo 1.jpg" alt="platos" ></Image>
    <Image width='200px' height='200px'src="./src/img/econo 2.jpg" alt="platos" ></Image>
    <Image width='200px' height='200px' src="./src/img/econo 3.jpg" alt="platos" ></Image>
